...
본 프로젝트는 학교 앱에서만 확인할 수 있는 식단 정보를 어디서든 자유롭게 활용할 수 있도록 **JSON 데이터** 형태로 제공합니다. <br>
별도의 서버 없이 GitHub Pages를 활용하여 안정성과 비용 효율성을 극대화했습니다.
...
```
---
✍️ How to Update (업데이트 방법) <br>
본 저장소의 meals.json 파일을 편집합니다. <br>
최신 날짜 데이터를 가장 위에 추가합니다. (최신순 정렬 권장) <br>
